...
Definition at line 9 of file AD9835.h.
...
{\em pinFSYNC} & The IO pin connected to the FSYNC pin of the AD9835. \\
\hline
{\em pinSCLK} & The IO pin connected to the SPI clock of the AD9835. \\
\hline
{\em pinSDATA} & The IO pin connected to the SPI data pin of the AD9835.\\
\hline
{\em pinFSEL} & The IO pin connected to the frequency select pin of the AD9835.\\
\hline
{\em pinPSEL1} & The IO pin connected to phase select pin one of the AD9835. \\
\hline
{\em pinPSEL0} & The IO pin connected to phase select pin zero of the AD9835.\\
\hline
{\em hzMasterClockFrequency} & The frequency of the AD9835 master clock in Hz.\\
\hline
\end{DoxyParams}
...
Definition at line 74 of file AD9835.cpp.
...
The \hyperlink{class_a_d9835_abd6cd79aa94760c1bfbb86d77dc493d6}{AD9835::begin} method sets pin modes and clears the state of the AD9835. \begin{Desc}
\item[Examples: ]\par
\hyperlink{_fixed_8pde-example}{Fixed.pde}.\end{Desc}


Definition at line 94 of file AD9835.cpp.
...
Definition at line 270 of file AD9835.cpp.
...
\begin{DoxyParams}{Parameters}
{\em degPhase} & The phase angle (in degrees) to be converted.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
Definition at line 295 of file AD9835.cpp.
...
Definition at line 208 of file AD9835.cpp.
...
The selectPhaseRegister drives the PSEL0 and PSEL1 pins of the AD9835, thereby setting the output phase to that set via setPhaseCode.
...
Definition at line 254 of file AD9835.cpp.
...
Definition at line 168 of file AD9835.cpp.
...
Definition at line 195 of file AD9835.cpp.
...
Definition at line 219 of file AD9835.cpp.
...
setPhaseDeg sets a phase register of the AD9835 to an angle given in degrees. This is slower than setPhaseCode, so using calculatePhaseCodeDeg directly and caching the result is desirable.
...
Definition at line 241 of file AD9835.cpp.
